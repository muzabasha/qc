    ...
    return (
        <div className="max-w-[1400px] w-full mx-auto p-6 md:p-12 space-y-12 md:space-y-24 pb-48 animate-in fade-in duration-700 relative">
            <header className="border-b-4 border-slate-800 pb-12 pt-8">
                <h1 className="text-5xl md:text-8xl font-black text-white mb-6">Module 4: Entanglement</h1>
                <p className="text-2xl md:text-4xl text-slate-400 font-medium">Spooky Action at a Distance: Connecting Qubits Across Space.</p>
            </header>
